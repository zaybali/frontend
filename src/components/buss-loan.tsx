...
// Loan categories and subcategories for business startup
const loanCategories = [
  {
    ...
    maxLoan: 1000000, // 10 Lakh PKR (example amount)
    loanPeriod: 60, // 5 years in months
  },
];

const BusinessStartupLoanComponent = () => {
  const [selectedSubcategory, setSelectedSubcategory] = useState<string>('Buy Stall');
      ...
      {showLoanDetails && (
        <div className="mt-6 p-4 border border-gray-300 rounded-md bg-gray-50">
          ...
          <p className="mt-1 text-gray-600">
            Monthly Payment: PKR {calculatedLoan.toFixed(2)}
          </p>
        </div>
      )}
...
export default BusinessStartupLoanComponent;
