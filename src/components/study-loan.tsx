...
// Loan categories and subcategories for education
const loanCategories = [
  {
    category: 'Education Loans',
    subcategories: ['University Fees', 'Child Fees Loan'],
    maxLoan: 1000000, // 10 Lakh PKR (example amount)
    loanPeriod: 48, // 4 years in months
  },
];

const EducationLoanComponent = () => {
  const [selectedSubcategory, setSelectedSubcategory] = useState<string>('University Fees');
